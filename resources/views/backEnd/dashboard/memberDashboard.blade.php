...
<section class="content">
  ...
  <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="support-box text-center blue">
                        ...
                        <div class="text m-b-10"><h3>Assign Task</h3></div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="support-box text-center green">
                        ...
                        <div class="text m-b-10"><h3>Points</h3></div>
                        <h3 class="m-b-0">
 ...
 <div class="text-center">
                                    <a href="{{url('teamMember/task-list')}}" class="b-b-primary text-primary">View All Task</a>
                                </div>
