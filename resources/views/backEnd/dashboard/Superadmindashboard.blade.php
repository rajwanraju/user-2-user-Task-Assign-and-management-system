...
<section class="content">
                ...
                <div class="col-lg-3 col-sm-6">
                  ...
                  <div class="col-lg-3 col-sm-6">
                    <div class="support-box text-center cyan">
                        ...
                        <div class="text m-b-10"><h3>Team Leader</h3></div>
                        <h3 class="m-b-0">{{$teamLeaders}}
 ...
 <div class="text-center">
                                    <a href="{{url('super-admin/taskList')}}" class="b-b-primary text-primary">View All Task</a>
                                </div>
